...
import { BookingQuery } from "../AllCars";
...
const FindCar: React.FC<{ setBookingQuery: React.Dispatch<React.SetStateAction<BookingQuery | null>> }> = ({ setBookingQuery }) => {
    ...
    const handleFindCar: SubmitHandler<FormData> = (data) => {
        ...
        setBookingQuery(bookingInfo)

    }
    return (
        <div className="my-10 max-w-2xl mx-auto px-2">
            <h1 className="[425px]:text-xl md:text-3xl first-line:font-bold mb-5 text-center">Find Car With Your Suitable Time!</h1>
            <form
